...
<head>
    ...
    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="<?php echo base_url('assets_c') ?>/css/vendor.css">
    <link rel="stylesheet" href="<?php echo base_url('assets_c') ?>/css/styles.css">

    <!-- favicons
    ================================================== -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo base_url('assets_c') ?>/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo base_url('assets_c') ?>/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url('assets_c') ?>/favicon-16x16.png">
    <link rel="manifest" href="<?php echo base_url('assets_c') ?>/site.webmanifest">
            ...
            <section id="intro" class="s-intro target-section">
                ...
                <div class="row s-intro__content">
                    ...
                    <div class="column lg-12 s-intro__content-inner">
                        <h3 class="s-intro__pretitle">We Are e-Pawnshop.</h3>
